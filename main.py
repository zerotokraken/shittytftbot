...
async def on_message(message):
    ...
    negative_responses = [
        ...
        'Can you stop clicking for fun augments don\'t blame me',
        'Have you tried like uh going top 4?',
        'Sorry I was getting you confused with vuhra',
        'Who are you?',
        'Did you mean to make those items? Oh..',
        'It\'s okay I never hit my units either.. just kidding',
        ...
        'it\'s okay to lose by 1 krug',
        '1v1 me on dust 2',
        'bro i\'d school you in fortnite'
    ]
    neutral_responses = [
        '*yay*',
