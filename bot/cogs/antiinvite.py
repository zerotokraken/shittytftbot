...
class AntiInvite(commands.Cog):
    def __init__(self, bot):
        ...
        self.allowed_roles = ["Hairy Frog", "Admin", "Discord Moderator", "Little Buddy TFT bot", "Boyses", "Riot", "Subreddit Moderator", "Caster", "Tournament Organizer", "HEX", "Little Buddy Bot"]  # Replace with your server's role names
